...
if(isset($_POST['submit']))
{
    ...
    $folder = 'img_platurtle/'.$file_name;

    $query = mysqli_query($con, "INSERT INTO `photos_pied-elephant` (file) VALUES ('$file_name')");
...
<html>
    ...
    <body>
        ...
        <div class="images">
            ...
            <?php
            $res = mysqli_query($con, "SELECT * FROM `photos_pied-elephant`");
            while($row = mysqli_fetch_assoc($res))
            {
            ?>
            <img src="img_platurtle/<?php echo $row['file'] ?>">
            <?php } ?>
        </div>
    </body>
    <script>
